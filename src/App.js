...
function App() {
  ...
  const loadContracts = async (signer) => {
    ...
    const xiroNFT = new ethers.Contract(
      XiroNFT_Address.address,
      XiroNFT_Abi.abi,
      signer
    );
    setXiroNFT(xiroNFT);
  ...
  const mintNFT = async (e) => {
    ...
    if (account) {
      try {
        ...
        const txResponse = await xiroNFT.mint(
          mintQty,
        ...
        {loading ? (
          <div className="container">
            ...
            <h2 className="nftCount">
              Accepted Wallet : <span className="green-text">Metamask</span>
            </h2>
          </div>
        ) : (
          <div className="container">
            ...
            <h2 className="nftCount">
              ...
              <span className="green-text">
                {nftBalanceValue && nftBalanceValue}
              </span>
              {!nftBalanceValue ? (
                <button className="get-btn" onClick={getBalance}>
                  CHECK
                </button>
              ) : (
                <button
                  className="get-btn"
                  onClick={() => setNftBalanceValue(null)}
                >
                  CLEAR
                </button>
              )}
            ...
            <div className="mint-qty">
              <div className="enter-qty">
                <span className="subtract" onClick={subtract}>
                  -
                </span>
            ...
            <h2 class="price">
              PRICE:<span class="green-text">&nbsp;0.1</span> ETH (+GAS FEES)
            </h2>
